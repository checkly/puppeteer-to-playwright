...
(async () => {
	...
	await page.waitForSelector(
		'.modal-content > .modal-body > .previewCart > .previewCartCheckout > .button:nth-child(6)'
	);
	...
	await page.waitForSelector(
		'.page > .page-content--full > .cart_actionbutton:nth-child(8) > .cart-actions > .button--primary'
	);
